...
activities = {
    ...
    "Basketball Club": {
        "description": "Develop basketball skills and play friendly pickup games",
    ...
    "Drama Club": {
        "description": "Create theater productions and practice acting skills",
    ...
    "Science Club": {
        "description": "Investigate science topics and run hands-on experiments",
